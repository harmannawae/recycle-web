...
<body translate="no">
    <div class="container">
        <table class="responsive-table">
            <caption>จัดการข้อมูลข่าวสาร</caption>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><a href='edit_newspaper.php?id=" . $row['n_id'] . "'>แก้ไข</a></td>";
                        echo "<td><a href='data.php?delete_newspaper_id=" . $row['n_id'] . "'
                         
                        onclick='return confirm(\"คุณต้องการลบเนื้อหาข่าวนี้หรือไม่\")'>ลบ</a>
