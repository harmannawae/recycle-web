...
<head>
    ...
    <title>ประวัติการซื้อทั้งหมด</title>
...
<body translate="no">
    <div class="container">
        <table class="responsive-table">
            <caption>จัดการข้อมูลประเภทขยะ</caption>
            <thead>
                <tr>
                    <th scope="col">ลำดับ</th>
                    <th scope="col">ชื่อ</th>
                    <th scope="col">สกุล</th>
                    <th scope="col">ประเภทขยะ</th>
                    <th scope="col">น้ำหนัก:</th>
                    <th scope="col">ราคาต่อ กก.</th>
                    <th scope="col">ราคารวม กก.</th>
                </tr>
            </thead>
            <tfoot>
            ...
            <tbody>
                ...
                $sql = "
                    ...
                    FROM order_history
                        ...
                        INNER JOIN user ON order_history.user_id = user.user_id
                ";
